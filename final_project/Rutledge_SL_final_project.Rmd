...
```{r}
df5$active_salvage <- ifelse(is.na(df5$collecting_method) & df5$coll_method_3 == "salvage", "salvage", 
         ifelse (df5$coll_method_3 == "salvage", "salvage", 
           ifelse (df5$coll_method_5 == "salvage", "salvage", 
             ifelse (df5$coll_method_6, "salvage", 
               ifelse (df5$collecting_method == "dead on road" | df5$collecting_method == "died on barbed wire fence" | df5$collecting_method == "euthanized" | df5$collecting_method == "euthanized while at Wetlands and Wildlife Care Center" | df5$collecting_method == "euthanized while at WWCC" | df5$collecting_method == "found injured and transferred to WWCC where euthanized" | df5$collecting_method == "found injured, transferred to WWCC and euthanized" | df5$collecting_method == "found injured, transferred to WWCC where euthanized" | df5$collecting_method == "found injured, transferred to WWCC, 'wobbly, lies down often', and euthanized on 2019-08-11" | df5$collecting_method == "gift" | df5$collecting_method == "salavage" | df5$collecting_method == "salbage" | df5$collecting_method == "salvage (caught in Tomahawk trap)" | df5$collecting_method == "salvage" | df5$collecting_method == "salvage (mammal trap)" | df5$collecting_method == "salvaged" | df5$collecting_method == "salvage-hit by vehicle", "salvage", "active")
               )
             )
           )
         )
