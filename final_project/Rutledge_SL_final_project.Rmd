...
```
```{r}
Table_2 =table(salvage_descend_genus$genus,salvage_descend_genus$cnt)
gfg_table
```


```{r}
knitr::kable(salvage_descend_genus[1:171,1:2], col.names = c("Genus", "Specimen Count"), format="markdown")
