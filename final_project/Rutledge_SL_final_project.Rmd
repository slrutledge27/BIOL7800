...
```{r}
### remove entries with parts "unknown" or "nest", as well as age "embryo" or "chick", as well as observations and recordings
df3 <- df2 %>% filter(!(parts=="unknown"|parts == "nest"|age=="embryo"|age=="chick"|collecting_method == "observation"|collecting_method =="observational"|collecting_method == "recording"))
